...
"""Check the published structured-address-fix suite agrees with its own policy.
...
* **A member left behind.** The structured-address-fix packages disagreed:
  0.0.3 and 0.0.3
...
#: Every published member of the structured-address-fix suite. The core is first.
MEMBERS = (
